...
Toast(params:=0) {
    ...
    position := params.position ? params.position : { x: "CENTER", y: "CENTER" }
    posX := position.x
    posY := position.y
    ...
    transparency := params.transparency ? params.transparency : "255"
    ...
    Loop, %monitorN% {
        ...
        Gui, %GUIHandleName%:Add, Text, xp+15 yp+15, %message%
